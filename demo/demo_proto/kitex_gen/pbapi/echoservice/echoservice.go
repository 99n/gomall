...
type EchoResult struct {
	Success *pbapi.Responce
}

var EchoResult_Success_DEFAULT *pbapi.Responce

func (p *EchoResult) FastRead(buf []byte, _type int8, number int32) (n int, err error) {
	if !p.IsSetSuccess() {
		p.Success = new(pbapi.Responce)
	}
...
func (p *EchoResult) GetSuccess() *pbapi.Responce {
	if !p.IsSetSuccess() {
...
func (p *kClient) Echo(ctx context.Context, Req *pbapi.Request) (r *pbapi.Responce, err error) {
	var _args EchoArgs
	_args.Req = Req
