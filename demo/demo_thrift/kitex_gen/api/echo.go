...
func (p *Responce) InitDefault() {
}

func (p *Responce) GetMessage() (v string) {
	return p.Message
}
func (p *Responce) SetMessage(val string) {
	p.Message = val
}

var fieldIDToName_Responce = map[int16]string{
	1: "message",
}

func (p *Responce) Read(iprot thrift.TProtocol) (err error) {
	var fieldTypeId thrift.TType
	var fieldId int16
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_Responce[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *Responce) ReadField1(iprot thrift.TProtocol) error {
...
func (p *Responce) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("Responce"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField1(oprot); err != nil {
...
func (p *Responce) writeField1(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("message", thrift.STRING, 1); err != nil {
		goto WriteFieldBeginError
	}
	if err := oprot.WriteString(p.Message); err != nil {
...
func (p *Responce) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("Responce(%+v)", *p)

}

func (p *Responce) DeepEqual(ano *Responce) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *Responce) Field1DeepEqual(src string) bool {
...
type Echo interface {
	Echo(ctx context.Context, req *Request) (r *Responce, err error)
}
...
func (p *EchoClient) Echo(ctx context.Context, req *Request) (r *Responce, err error) {
...
type EchoEchoResult struct {
	Success *Responce `thrift:"success,0,optional" frugal:"0,optional,Responce" json:"success,omitempty"`
}
...
var EchoEchoResult_Success_DEFAULT *Responce

func (p *EchoEchoResult) GetSuccess() (v *Responce) {
	if !p.IsSetSuccess() {
...
func (p *EchoEchoResult) Field0DeepEqual(src *Responce) bool {
